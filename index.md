...
* [Stable](/docs/specs/otel/document-status.md) for the trace, metric and log signals.
* [Development](/docs/specs/otel/document-status.md) for the profiles signal.
...
messages ([ExportLogsServiceRequest](https://github.com/open-telemetry/opentelemetry-proto/tree/v1.11.0/opentelemetry/proto/collector/logs/v1/logs_service.proto) for logs,
[ExportMetricsServiceRequest](https://github.com/open-telemetry/opentelemetry-proto/tree/v1.11.0/opentelemetry/proto/collector/metrics/v1/metrics_service.proto) for metrics,
[ExportTraceServiceRequest](https://github.com/open-telemetry/opentelemetry-proto/tree/v1.11.0/opentelemetry/proto/collector/trace/v1/trace_service.proto) for traces,
[ExportProfilesServiceRequest](https://github.com/open-telemetry/opentelemetry-proto/tree/v1.11.0/opentelemetry/proto/collector/profiles/v1development/profiles_service.proto) for profiles).
...
[Export\<signal>ServiceResponse](https://github.com/open-telemetry/opentelemetry-proto/tree/v1.11.0/opentelemetry/proto/collector) message
...
[Export\<signal>ServiceResponse](https://github.com/open-telemetry/opentelemetry-proto/tree/v1.11.0/opentelemetry/proto/collector)
...
gRPC service definitions [are here](https://github.com/open-telemetry/opentelemetry-proto/tree/v1.11.0/opentelemetry/proto/collector).

Protobuf definitions for requests and responses [are here](https://github.com/open-telemetry/opentelemetry-proto/tree/v1.11.0/opentelemetry/proto).

Please make sure to check the proto version and [maturity level](https://github.com/open-telemetry/opentelemetry-proto/tree/v1.11.0/README.md#maturity-level).
...
OTLP/HTTP and OTLP/gRPC as [defined here](https://github.com/open-telemetry/opentelemetry-proto/tree/v1.11.0/opentelemetry/proto).
...
For JSON payload examples see: [OTLP JSON request examples](https://github.com/open-telemetry/opentelemetry-proto/tree/v1.11.0/examples/README.md)
