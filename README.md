...
Because interruption is advisory, sending the owned interrupt itself makes the
delivery outcome conservatively false even if an exporter clears the interrupt
and returns true.
